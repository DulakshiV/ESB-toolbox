...
//        callbackStore = Collections.synchronizedMap(new HashMap<String, AxisCallback>());
    ...
    public void receive(MessageContext messageCtx) throws AxisFault {
        ...
        messageCtx.setProperty("CommonMessageID","12345");
    ...
    private void handleMessage(String messageID ,MessageContext response,
        ...
        if (o != null && Boolean.TRUE.equals(o)) {
            ...
            System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!! String messageid"+messageID);
            axisOutMsgCtx.setProperty("CommonMessageID", (String)axisOutMsgCtx.getMessageID());
            System.out.println("Out message id set to:" +(String)axisOutMsgCtx.getProperty("CommonMessageID"));
     //       axisOutMsgCtx.setMessageID(response.getMessageID());///////////////////////////////////////////////////
          System.out.println("response message id set to:" +(String)response.getMessageID());
          System.out.println("response message id set to:" +(String)axisOutMsgCtx.getMessageID());
