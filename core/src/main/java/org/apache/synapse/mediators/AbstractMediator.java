...
public abstract class AbstractMediator implements Mediator, AspectConfigurable {
    ...
    /*private long startTime, endTime; //to save the start and end time passed by abstractlist

    private boolean success=true; //to denote successful execution of a mediator
	...
	*/
    ...
    public String getShortDescription() {
    	//System.out.println("Description: "+this.shortDescription); ///////////////////////////
    	//log.error(shortDescription);
    ...
    protected void handleException(String msg, MessageContext msgContext) {
    	System.out.println("Handle exception pabstract medi");
