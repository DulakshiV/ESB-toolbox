...
public class Target {
    ...
    public boolean mediate(MessageContext synCtx) {
        ...
        System.out.println("#############################ID from target#####################"+synCtx.getRoot().getContents().getMsgID());
    	System.out.println("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$*************************newCtx.getid"+synCtx.getCurrent().getContents().getId());
        ...
        if (sequence != null) {
            ...
            if (refSequence != null) {
                if (asynchronous) {
                    ...
                    System.out.println("Inject async");
