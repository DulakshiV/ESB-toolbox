...
public class AggregateMediator extends AbstractMediator implements ManagedLifecycle,
    ...
    public boolean mediate(MessageContext synCtx,
        ...
        if (!contState.hasChild()) {
            ...
            System.out.println("***********printng parent from aggregatemediator"+current.getChildren());
            ...
            System.out.println("***********printng parent from aggregatemediator"+current.getParent());
        }
        MediatorData.setEndingTime(current);
        synCtx.setCurrent(current.getParent());
        return result;
    ...
    public boolean completeAggregate(Aggregate aggregate) {
        ...
        if ((correlateExpression != null &&
            ...
            if (onCompleteSequence != null) {
                ...
                boolean result= newSynCtx.getSequence(onCompleteSequenceRef).mediate(newSynCtx);
