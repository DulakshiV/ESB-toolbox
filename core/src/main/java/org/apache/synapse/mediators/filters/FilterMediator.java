...
public class FilterMediator extends AbstractListMediator implements
    ...
    private String elseKey = null;SuperMediator a;
     ...
     //  current= MediatorData.createNewMediator(synCtx, this);
        ...
        if (test(synCtx)) {
            ...
            if (thenKey != null) {
                ...
                System.out.println("*********************Line 141 of filter");
                Mediator seq = synCtx.getSequence(thenKey);
                if (seq != null) {
                    result = seq.mediate(synCtx);
                    System.out.println("***********printng parent from filtermediator"+current.getParent());
                ...
                System.out.println("***********printng parent from filtermediator which is now calling to abstractlist at line 190 "+current.getParent());
                if (result) {
            ...
            if (elseKey != null) {
                ...
                if (elseSeq != null) {
                    ...
                    System.out.println("***********printng parent from filtermediator which is now calling to else seq at line 215 "+current.getParent());
                } else {
                ...
                System.out.println("***********printng parent from filtermediator which is now calling to else seq at line 232 "+current.getParent());
