...
//	TreeNode current;
    ...
    public boolean mediate(MessageContext synInCtx) {
        ...
        synOutCtx.setCurrent((TreeNode)synOutCtx.getProperty("copyCurrent"));
        ...
        if (outOnlyMessage) {
        	System.out.println("Call mediator return true");
            return true;
        }
    	System.out.println("Call mediator return false current node is"+synInCtx.getCurrent().getContents().getMediatorName());
